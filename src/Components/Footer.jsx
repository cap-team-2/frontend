...
export default function Footer() {
  return (
    <footer className="flex flex-col items-center justify-center text-center gap-4 pt-4 pb-16 bg-white text-green h-auto w-full border-t border-gray  tablet:py-20 tablet:items-start tablet:px-10 desktop:px-40 xl:px-48 relative ">
      {/* Additional Links */}
