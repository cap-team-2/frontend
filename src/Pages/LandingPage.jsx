      ...
      <div className="h-auto w-full flex flex-col bg-white pt-16 tablet:pt-16 desktop:px-36 xl:px-80 ">
          ...
          <div className="flex flex-col items-center justify-center h-full w-full absolute pb-4 tablet:pt-20 desktop:p-0">
            ...
            <div className=" bg-black bg-opacity-40 h-40 w-full flex justify-center items-center ">
              <h1 className="text-white text-[26px] tablet:text-4xl font-medium text-center py-4 mobile:w-[480px]">
                ...
                Your <span className="text-green">Community</span>
              </h1>
            </div>
            {/* Get Started Button */}
            <Link
        ...
        <div className=" h-auto w-full my-10">
          ...
          <p className="text-center mt-4 p-4">
            ...
            sustainable lifestyle. By choosing us, you&#39;re not only
            simplifying the process of discovering delicious cuisine; you&#39;re
            also supporting local agriculture and fostering a stronger
            community. Explore the satisfaction of our customers who have found
            produce, markets, and valuable farmer information on our website.
            Join us in cultivating a meaningful connection between growers and
            enthusiasts, all while advocating for a more interconnected and
            sustainable future.
          </p>
        </div>
        {/* reviews */}
        <div className="h-full w-full flex flex-col gap-10 mb-10 justify-center tablet:flex-row">
          <div className="flex flex-col gap-4 items-center  text-center px-4 w-96">
            ...
            />
            <p>
              Since I found Pantri, I have been making healthier decisions, and
              it has brought me peace of mind to know the origins of my food. I
              would strongly suggest giving it a try - Anita, Queens NY
            </p>
          </div>
          <div className="flex flex-col gap-4 items-center text-center px-4 w-96">
            <img
            ...
            <p>
              ...
              customers and new friends at farmers markets, with zero crop
              wastage - Steven, Evergreen Meadows Farm
            </p>
          </div>
        </div>
        <div className="px-4 mb-10 flex w-full justify-center">
          <img src={veggieImage} alt="Vegetables on shelves" className="h-96 w-auto object-cover"/>
        </div>
      </div>
    );
}