  ...
  return (
    <div>
      <div>
        ...
        <label>
          Zip Code:
          <input type="text" value={filterZip} onChange={(e) => setFilterZip(e.target.value)} />
        </label>
        <label>
          City:
        ...
        <div className="bg-green p-6 rounded shadow-lg">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <button className="bg-blue-500 text-white px-4 py-2 mt-4 rounded hover:bg-blue-700" onClick={handleCloseDetails}>Close Details</button>
            </div>
          </div>
        </div>
      )}
